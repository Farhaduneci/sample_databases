...
INSERT INTO `customers` (`id`, `customer_name`, `last_name`, `first_name`, `phone`, `address_line_1`, `address_line_2`, `city`, `state`, `postal_code`, `country`, `sales_rep_employee_number`, `creditLimit`) VALUES
...
INSERT INTO `employees` (`id`, `last_name`, `first_name`, `extension`, `email`, `office_code`, `reports_to`, `job_title`) VALUES
...
INSERT INTO `orders` (`order_id`, `order_date`, `required_date`, `shipped_date`, `status`, `comments`, `id`) VALUES
...
INSERT INTO `order_details` (`order_id`, `product_id`, `quantity`, `unit_price`, `order_line_number`) VALUES
...
INSERT INTO `payments` (`id`, `check_number`, `payment_date`, `amount`) VALUES
...
INSERT INTO `products` (`id`, `name`, `product_line`, `scale`, `vendor`, `dscription`, `quantity_in_stock`, `price`, `msrp`) VALUES
...
ALTER TABLE `payments`
  ADD PRIMARY KEY (`id`,`check_number`);
...
--
ALTER TABLE `customers`
  ADD CONSTRAINT `customers_ibfk_1` FOREIGN KEY (`sales_rep_employee_number`) REFERENCES `employees` (`id`);

--
-- Constraints for table `employees`
--
ALTER TABLE `employees`
  ADD CONSTRAINT `employees_ibfk_1` FOREIGN KEY (`reports_to`) REFERENCES `employees` (`id`),
...
--
ALTER TABLE `products`
  ADD CONSTRAINT `products_ibfk_1` FOREIGN KEY (`product_line`) REFERENCES `product_lines` (`product_line`);
COMMIT;
